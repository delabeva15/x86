...
But one approach I had was to simply use objdump to better understand- this helped
some. If I could do italics here I would, some in italics. It more helped me 
understand stack frames and other concepts i've been reviewing since October. 

But it did show me something I was worried about was far simplier than I imagined-
structures in c are really easy, and, in my opinion, easy in assembly as well.

its just a simple memory allocation :)

anyways, here is the decompiled charLive.exe program written in C, the main 
content you'll want to look at will be under the main label. 

(update- i've removed the "extra" content to highlight main and my annotations- 
it is really cool!)
...
;here is edi- its 0 again, as seen from DWORD above. Either read or delay 
